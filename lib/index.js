...
var antdSpin = /*#__PURE__*/ (function () {
  ...
  _createClass(antdSpin, [
      ...
      value: function service() {
        ...
        if (!this.requestFlag) {
          ...
          if (typeof options.target === "string" && options.target.length) {
            this.targetDOM =
              document.querySelector("#".concat(options.target)) || document.querySelector(".".concat(options.target));
    ...
    },
    {
      key: "customSpinIcons",
      value: (function () {
        var _customSpinIcons = _asyncToGenerator(
          /*#__PURE__*/ regeneratorRuntime.mark(function _callee() {
            var _this$options$loading,
              _this2 = this;

            var loadingConfig,
              _this$options$IconFon,
              type,
              scriptUrl,
              IconFont,
              loadingMapConfig,
              ...
              function _callee$(_context) {
                while (1) {
                  switch ((_context.prev = _context.next)) {
                    case 0:
                      loadingConfig =
                        (_this$options$loading = this.options.loadingConfig) !== null &&
                        _this$options$loading !== void 0
                    ...
                    */
                    ...
                    case 4:
                      ...
                      if (
                        !(
                          this.options.IconFont.type ||
                          this.options.IconFont.scriptUrl ||
                          this.options.indicator.length
                        )
                      ) {
                        _context.next = 7;
                        break;
                    ...
                    case 10:
                      ...
                      (_this$options$IconFon = this.options.IconFont),
                        (type = _this$options$IconFon.type),
                        (scriptUrl = _this$options$IconFon.scriptUrl);
                    ...
                    case 27:
                      return _context.abrupt(
                        "return",
                        /*#__PURE__*/ React.createElement(AntDesignIcons, loadingConfig)
                      );
